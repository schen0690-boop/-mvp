...
export default defineConfig({
 ...
 outputDir:'evidence/stage-6a/raw/local-results',reporter:[['list'],['json',{outputFile:'evidence/stage-6a/raw/local-e2e.json'}]],
 use:{baseURL:'http://127.0.0.1:41871',browserName:'chromium',channel:'msedge',headless:true,viewport:{width:1366,height:768},screenshot:'only-on-failure',trace:'retain-on-failure'},
